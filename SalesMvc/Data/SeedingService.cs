...
namespace SalesMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //encerra caso o banco de dados já tenha sido populado
            }
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bog@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 1900.0, d3);
            Seller s3 = new Seller(3, "Geraldo Garcia", "geraldo@gmail.com", new DateTime(1972, 8, 6), 1200.0, d3);
            Seller s4 = new Seller(4, "Alex Toth", "alex@gmail.com", new DateTime(1993, 11, 30), 1300.0, d4);
            Seller s5 = new Seller(5, "Martha Behar", "martha@gmail.com", new DateTime(2000, 1, 9), 1250.0, d2);
            Seller s6 = new Seller(6, "Dona Wilson", "dona@gmail.com", new DateTime(1997, 3, 4), 1430.0, d1);
